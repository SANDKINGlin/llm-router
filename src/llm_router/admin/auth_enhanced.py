...
# JWT配置
SECRET_KEY = os.environ.get("ADMIN_SECRET_KEY", "dev-secret-key-32bytes-aaaa-1111")  # 跟 auth.py AuthMiddleware 对齐 (F10-4 cherry-pick, R32 三方共识 6 DISCARD + 1 cherry-pick)
ALGORITHM = "HS256"
